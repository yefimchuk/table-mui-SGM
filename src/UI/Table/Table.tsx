                                ...
                                columns.map(
                                    (
                                        item:
                                            ...
                                            | null
                                            | undefined
                                    ) => <TableCell style={{backgroundColor: '#13171c', color: '#f0f6fc',}}
                                                    key={uniqid()}>{item}</TableCell>
                                )
                            )}
                        </TableRow>
                    </TableHead>
                            ...
                            <TableRow key={uniqid()}>
                                ...
                                {years.flatMap((n: string | number) =>
                                    columns.map((m: string | number) => (
                                        <TableCell style={{backgroundColor: '#21262d', fontSize: 16, color: 'white'}}
                                                   key={uniqid()} onClick={openWindow}>
                                            {G[n]?.[m]?.value ?? 0}
                                        </TableCell>
                                    ))
                                )}
